...
public class FireArrowEntity
    ...
    protected void onCollision(HitResult hitResult) {
        ...
        if (type == HitResult.Type.ENTITY) {
            ...
            BlockPos blockPos;
            if (this.getWorld().getGameRules().getBoolean(GameRules.DO_MOB_GRIEFING) && this.getWorld().isAir(blockPos = blockHitResult.getBlockPos().offset(blockHitResult.getSide()))) {
